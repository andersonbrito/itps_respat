...
if __name__ == '__main__':
    ...
    # output2 = input_folder + 'amostras_inconsistencias.txt'
    # outfile2 = open(output2, 'w')
    # outfile2.write('\t'.join(['pedido', 'alvo', 'valor_Ct', 'total_alvos_testados', 'arquivo']) + '\n')
    ...
    def fix_datatable(dfL, lab, file):
        dfN = dfL
        if lab == 'DB Molecular':
            pathogens = {'FLUA': ['FLUARV'], 'FLUB': ['FLUBRV'], 'VSR': ['RSVRV'], 'SC2': ['NGRV', 'SGRV', 'RDRPGRV'],
            ...
            pathogens = {'FLUA': ['VIRUS_Influenza A', 'VIRUS_Influenza H1N1', 'VIRUS_Influenza H3'], 'FLUB': ['VIRUS_Influenza B'],
                         'META': ['VIRUS_Metapneumovírus'], 'VSR': ['VIRUS_Sincicial A', 'VIRUS_Sincicial B'], 'RINO': ['VIRUS_Rinovírus'],
                         ...
                         'SC2': ['VIRUS_SARS_Like', 'VIRUS_SARS-CoV-2'], 'ENTERO': ['VIRUS_Enterovírus'],
    ...
    key_cols = ['lab_id', 'test_id', 'sample_id', 'state', 'location', 'sex', 'date_testing', 'epiweek', 'age',
